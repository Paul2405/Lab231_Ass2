...
<html>
    ...
    <body>
        <div class="container">
            ...
            <span>Welcome ${INFO.getName()}</span> <br><a href="logout">logout </a>&#124<c:if test="${INFO.getRole().trim() == 'admin'}" var="testRole"><a href="loadPromotion"> Promotion List</a></c:if>
            <c:if test="${!testRole}"><a href="update?id=${INFO.getId()}">Edit my profile</a></c:if>&#124<a href="activity?id=${INFO.getId()}"> Activity history</a>
            <br/><br/>
                ...
                <li class="active"><a data-toggle="tab" href="load?btnAction=user">User</a></li>
            </ul>
                        ...
                        <div class="table-responsive">
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <h2><b>All User Management ${GroupName}</b></h2>
                                        </div>
                                        <c:if test="${INFO.getRole().trim() == 'admin'}">
                                            <div class="col-xs-4">
                                                <form action="search" method="POST">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="hidden" name="btnAction" value="user"/>
                                    ...
                                    <c:if test="${not empty USER }" var="testNull">
                                        <tbody>
                                            <c:forEach items="${USER}" var="user" varStatus="counter">
                                                <c:if test="${user.getRole().trim() == 'user'}">
                                                    <tr>
